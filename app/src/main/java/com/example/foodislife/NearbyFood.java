...
import com.example.foodislife.databinding.ActivityNearbyFoodBinding;
...
public class NearbyFood extends FragmentActivity implements OnMapReadyCallback {

    private GoogleMap mMap;
    private ActivityNearbyFoodBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityNearbyFoodBinding.inflate(getLayoutInflater());
        ...
        DatabaseReference foodMapRef = FirebaseDatabase.getInstance().getReference("NearbyFood");
        childEventListener = new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String previousChildName) {
                ...
                Marker marker = mMap.addMarker(new MarkerOptions().position(userLocation).title(c+"||"+d).icon(setIcon(NearbyFood.this, R.drawable.marker_donator_style)));
            ...
            public void onChildChanged(@NonNull DataSnapshot dataSnapshot, @Nullable String previousChildName) {
                ...
                Toast.makeText(NearbyFood.this, "T1", Toast.LENGTH_SHORT).show();
            }
            @Override
            ...
            public void onChildMoved(@NonNull DataSnapshot dataSnapshot, @Nullable String previousChildName) {
                ...
                Toast.makeText(NearbyFood.this, "T3", Toast.LENGTH_SHORT).show();
            }
            @Override
            public void onCancelled(@NonNull DatabaseError databaseError) {
                // Handle any errors that occur during the database operation
                Toast.makeText(NearbyFood.this, "T4", Toast.LENGTH_SHORT).show();
            }
        };
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.setMapStyle(MapStyleOptions.loadRawResourceStyle(NearbyFood.this,R.raw.map_style));  // map style
